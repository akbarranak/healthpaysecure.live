  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="bg-red-600 text-white p-3 md:p-6 rounded-lg md:rounded-xl shadow-lg w-[92%] mx-auto">
            <div className="flex items-center justify-center mb-2 md:mb-3">
              <AlertTriangle className="w-5 h-5 md:w-7 md:h-7 mr-1 md:mr-2 text-yellow-300" />
              <span className="text-sm md:text-lg font-black uppercase tracking-wider text-yellow-300">
            ...
            <p className="text-xs md:text-base lg:text-lg">
              ...
              <span className="font-bold">GOLIATH XL10</span>. Only purchase from authorized retailers to ensure you
              receive the genuine product.
            </p>

            {/* Counterfeit replacement button */}
            <div className="mt-2 md:mt-4 flex justify-center px-4 md:px-0">
