  ...
  return (
    <section className="mb-12 md:mb-20">
      <motion.div
        ...
        viewport={{ once: true }}
        className="backdrop-blur-sm bg-gradient-to-r from-blue-700 to-blue-600 dark:from-blue-900 dark:to-blue-800 border border-blue-500/50 dark:border-blue-700/50 rounded-xl md:rounded-3xl p-6 md:p-12 overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.3)] relative"
      >
        {/* Glow effect */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-500 rounded-full filter blur-[100px] opacity-20"></div>

        <div className="grid md:grid-cols-2 gap-6 md:gap-12 items-center">
          <div>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-4 md:mb-6 drop-shadow-md">
              Experience <span className="text-yellow-300 font-extrabold">Goliath XL10</span>
            </h2>
            ...
            <div className="bg-green-600 p-3 md:p-4 rounded-lg md:rounded-xl mb-4 md:mb-6">
              <div className="flex items-center justify-between">
                ...
                <div className="bg-red-600 text-white rounded-lg px-2 py-1 md:px-3 md:py-1 font-bold text-xs md:text-base">
                  30% OFF
                </div>
              </div>
            </div>
