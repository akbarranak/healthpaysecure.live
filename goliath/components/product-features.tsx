...
export default function ProductFeatures() {
  return (
    <section className="mb-12 md:mb-20">
      ...
      >
        {/* Glow effect */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-cyan-500 rounded-full filter blur-[100px] opacity-10 dark-theme:opacity-10 light-theme:opacity-5"></div>

        <div className="relative">
          <div className="flex items-center justify-center mb-6 md:mb-10">
            <div className="h-0.5 bg-gradient-to-r from-transparent via-cyan-500 to-transparent w-full max-w-xs hidden md:block"></div>
            ...
            <div className="order-2 md:order-1">
              ...
              >
                ...
                <p className="text-sm md:text-lg text-[var(--text-secondary)]">
                  Goliath XL10 is manufactured in state-of-the-art facilities under strict quality control standards.
                  Our formula has been perfected over years of research to deliver maximum results with no side effects.
                </p>
                <ul className="space-y-2">
                  {/* Changed to green checkmarks */}
            ...
            <div className="relative order-1 md:order-2 flex justify-center mb-6 md:mb-0">
              ...
              >
                ...
                <div className="relative w-44 h-56 sm:w-56 sm:h-72 md:w-72 md:h-96">
                  <div className="absolute inset-0 bg-gradient-to-b from-cyan-500/20 to-blue-500/20 rounded-full filter blur-[60px] opacity-70 dark-theme:opacity-70 light-theme:opacity-40"></div>
                  <Image
                    src="/images/GOLIATH_XL10.png"
                    alt="Goliath XL10 Product"
                    fill
