export default function Footer() {
  return (
    <footer className="bg-black text-white dark:bg-white dark:text-black py-6 md:py-12">
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          <div>
            <h3 className="text-base md:text-lg font-bold mb-3 md:mb-4">Goliath XL10</h3>
            <p className="text-xs md:text-sm text-gray-400 dark:text-gray-600 mb-4">
          ...
          <div>
            ...
            <ul className="space-y-1 md:space-y-2 text-xs md:text-sm text-gray-400 dark:text-gray-600">
              <li>
        ...
        <div className="mt-6 md:mt-8 pt-4 md:pt-8 border-t border-gray-800 dark:border-gray-300">
          <div className="text-xs text-gray-500 dark:text-gray-600">
            ...
            <p>© {new Date().getFullYear()} Goliath XL10. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
