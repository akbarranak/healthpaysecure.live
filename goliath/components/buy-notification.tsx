    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed md:bottom-6 bottom-16 left-2 md:left-4 z-50 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-2 md:p-4 max-w-[calc(100vw-1rem)] md:max-w-xs border-l-4 border-green-500"
        >
          <button
          ...
          <div className="flex items-start">
            <div className="flex-shrink-0 bg-green-100 dark:bg-green-900 rounded-full p-1 md:p-2 mr-2 md:mr-3">
            ...
            <div>
              ...
              <p className="text-xs md:text-sm text-gray-600 dark:text-gray-300">
                just purchased {notification.quantity} {notification.quantity === 1 ? "bottle" : "bottles"} of GOLIATH
                XL10
              </p>
