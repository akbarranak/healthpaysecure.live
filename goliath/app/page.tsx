    ...
    <main className="min-h-screen bg-gradient-to-b from-[var(--bg-gradient-from)] via-[var(--bg-gradient-via)] to-[var(--bg-gradient-to)] text-[var(--text-primary)]">
      <div className="relative">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute -top-40 -right-40 w-96 h-96 bg-purple-600 rounded-full filter blur-[120px] opacity-20 dark-theme:opacity-20 light-theme:opacity-10"></div>
          <div className="absolute top-1/3 -left-40 w-96 h-96 bg-blue-600 rounded-full filter blur-[120px] opacity-20 dark-theme:opacity-20 light-theme:opacity-10"></div>
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-cyan-600 rounded-full filter blur-[120px] opacity-10 dark-theme:opacity-10 light-theme:opacity-5"></div>
        </div>
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-4 md:py-8">
          ...
          <div className="text-center mb-6 md:mb-12 pt-4 md:pt-8">
            ...
            {/* Removed "PRODUCT RENAMED" text */}
            <h1 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-extrabold mb-2 md:mb-4 text-red-600 text-center">
