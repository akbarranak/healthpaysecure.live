      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 md:p-8">
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <p>
              By accessing or using the Goliath XL10 website ("Site") and purchasing our products, you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Site or
              purchase our products.
            </p>

            <h2 className="text-xl font-semibold mt-6 mb-3">2. Products and Services</h2>
            <p>
              Goliath XL10 is a dietary supplement designed for adult males. Our products are not intended to diagnose,
              treat, cure, or prevent any disease. The information provided on our Site is for informational purposes
            ...
            <p>
              All content on our Site, including text, graphics, logos, images, and software, is the property of Goliath
              XL10 or its content suppliers and is protected by United States and international copyright laws. The
              compilation of all content on this Site is the exclusive property of Goliath XL10 and is protected by
            ...
            <p>
              IN NO EVENT SHALL GOLIATH XL10, ITS OFFICERS, DIRECTORS, EMPLOYEES, OR AGENTS, BE LIABLE FOR ANY INDIRECT,
              INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES ARISING OUT OF OR RELATED TO YOUR USE OF OUR SITE
              OR PRODUCTS.
            </p>
            ...
            <p>
              You agree to indemnify, defend, and hold harmless Goliath XL10, its officers, directors, employees,
